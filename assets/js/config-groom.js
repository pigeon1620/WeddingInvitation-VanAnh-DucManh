window.WEDDING_CONFIG = {
  ...
  text: {
    ...
    invitationEyebrow: "Together With Our Families",
    invitationTitle: "Tiệc cưới tại nhà trai",
  ...
  ui: {
    selectedEventKey: "groom", // chọn tiệc cưới của nhà trai // selectedEventKey chọn tiệc cưới: "bride" hoặc "groom"
    sections: {
      story: true,
      invitation: true,
      event: true,
